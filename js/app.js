(() => {
    ...
    (() => {
        ...
        document.addEventListener("click", (function(e) {
            let close = document.querySelector(".allert-header__close img");
            if (e.target == close) {
                let allert = document.querySelector(".header__allert");
                allert.style.display = "none";
            }
            let menuArrows = document.querySelectorAll(".menu__link img");
            for (const menuArrow of menuArrows) if (isMobile.any()) if (e.target == menuArrow) {
                e.preventDefault();
                menuArrow.closest(".menu__item").classList.toggle("active");
            } else if (e.target != menuArrow) menuArrow.closest(".menu__item").classList.remove("active");
        }));
        isWebp();
        menuInit();
        formFieldsInit({
